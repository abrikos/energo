...
@observer
export default class ElectricalSafetyList extends React.Component {
	@observable records;
		...
		return (
			<div>
				<div className="filters">
					<Button label="Добавить категорию" onClick={() => this.props.history.push('/admin/electricalsafeties/new')} />
				</div>
